    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="editsize" method="post">
                ...
                <input type="text" id="id" name="id" value="${editS.productid}" readonly><br><br>

                <label for="sizename">Kích cỡ:</label>
                <input type="text" id="sizename" name="sizename" value="${editS.sizename}" readonly><br><br>

                <label for="quantity">Quantity:</label>
                <input type="text" id="quantity" name="quantity" value="${editS.quantity}"><br><br>
                <input type="hidden"  name="sizeid" value="${editS.sizeid}">
