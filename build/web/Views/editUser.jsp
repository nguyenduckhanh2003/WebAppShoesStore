    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="edituser" method="post">
                ...
                <input value="${user.userid}" type="text" id="id" name="id" readonly><br><br>
                <label for="name">Tên đăng nhập:</label>
                <input value="${user.username}" type="text" id="name" name="name" readonly><br><br>

                <label for="password">Mật khẩu:</label>
                <input value="${user.password}" type="text" id="password" name="password" readonly><br><br>

                <label for="email">Email:</label>
                <input value="${user.email}" type="text" id="email" name="email" readonly><br><br>
